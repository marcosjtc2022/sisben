...
//    }
//
//    public  Boolean dataMaiorQueDataAtual(Date data)  {
...
//    }
//
//    public  Date dataBDEquivalenteNula() {
//        return asDate(LocalDateTime.of(1900, 1, 1, 0, 0, 0));
//    }
//
//    public  boolean dataEquivalenteNula(Date data) {
...
//    }
//    
//    public  LocalDateTime asLocalDateTimeEquivalenteNula() {
//    	return LocalDateTime.of(1900, 1, 1, 0, 0, 0);
//    }
//
//
//	public  Date ultimoDiaMesComHora(Integer mes, Integer ano){
...
////    }
//    
//	public  LocalDateTime converteStringDataParaLocalDateTime(final String data) {
//		LocalDateTime ldt;
...
//	}
//	
//	public  LocalDate converteStringDataParaLocalDate(final String data) {
//		LocalDate ld;
...
//	}
//	
//	public  LocalDate converteStringParaLocalDatePattern(final String data, String pattern) {
//
...
//	}
//
//	public  boolean dataFimDeSemana(LocalDate dataVerificar) {
...
//	public  boolean tempoMaiorTrintaDias(LocalDateTime dataVerificar){
...
//	
//	// Verifica se a data passada é maior que a data atual mais 30 dias
//	public  boolean tempoMaiorTrintaDias(LocalDate dataVerificar)
//	{
...
//	
//	
//	public LocalDateTime trataDatas(String dt) {
